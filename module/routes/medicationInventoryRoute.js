...
import { addMedicationInventory,
     getAllMedicationInventory,
     addMedicationByCaretaker,
     getAllMedicationByCaretaker,
      softDeleteMedication } from "../controllers/medicationInventoryController.js";
...
router.get("/getAllByCaretaker/:patientId", verifyAccessToken, getAllMedicationByCaretaker);
